...
module.exports = (app) => {
    ...
    app.get('/user/:id', authMiddleware, getUser) //paramsId, validateErrorUser, 
    app.put('/user/:id', authMiddleware, put) //paramsId, validateFoundById, validateCreate, validateErrorUser, validateDuplicatedUserEmail,
    app.delete('/user/:id', authMiddleware, removeUser)// paramsId, validateFoundById, validateErrorUser, 
